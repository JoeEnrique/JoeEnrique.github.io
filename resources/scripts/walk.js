...
function initialize() {
  let place = document.getElementById("panel");
  ...
  place.appendChild(bouncearea.element);
}
...
function next_Color() {
  ...
  document.getElementById("bouncearea").style.backgroundColor =
